...
assert.deepEqual(string.getHsla('hsla(.5, 100%, 50%, -0.2)'), [0.5, 100, 50, 0]);
assert.deepEqual(string.getHwb('hwb(+240, 100%, 50.5%)'), [240, 100, 50.5, 1]);
...
// invalid
assert.strictEqual(string.getRgba('yellowblue'), null);
assert.strictEqual(string.getRgba('hsl(100, 10%, 10%)'), null);
assert.strictEqual(string.getRgba('hwb(100, 10%, 10%)'), null);
